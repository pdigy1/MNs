...
coinname=labx
coinnamed=labxd
coinnamecli=labx-cli
ticker=labx
coindir=labx
binaries='https://yadi.sk/d/9bLTBLfRq4aS8w'
snapshot='https://yadi.sk/d/6-uqMFqvUrJOUQ'
port=33330
rpcport=33329
pass=`pwgen 14 1 b`
...
#Tool menu
echo -e '\e[4mStarting labx MultiNode tools\e[24m'
...
echo -e '\e[4mWelcome to the labx Multitools\e[24m'
...
#Tools
    ...
    exit
    ;;
    4)  echo "Starting labx MasterNode install"
    ;;
    esac
...
cd /usr/local/bin
wget https://getfile.dokpub.com/yandex/get/https://yadi.sk/d/9bLTBLfRq4aS8w -O ${coinname}.zip
unzip ${coinname}.zip
chmod +x ${coinnamecli} ${coinnamed}
rm ${coinanme}.zip
...
# echo "addnode=dnsseed.labxnodes.com" >> $coinname.conf
# echo "addnode=dnsseed2.labxnodes.com" >> $coinname.conf
...
echo -e '\e[4m'$alias' '$ipadd':33330 '$key'\e[24m'
echo ""
...
echo ""
echo "For more information or support please visit the labx Masternode-support channel on Discord"
