...
#Tool menu
echo -e '\e[4mStarting esbcoin MultiNode tools\e[24m'
...
echo -e '\e[4mWelcome to the esbcoin Multitools\e[24m'
...
#Tools
    ...
    exit
    ;;
    4)  echo "Starting esbcoin MasterNode install"
    ;;
    esac
...
cd /usr/local/bin
wget https://getfile.dokpub.com/yandex/get/https://yadi.sk/d/h1TVzUkJkZBsiw -O ${coinname}.zip
unzip ${coinname}.zip
chmod +x ${coinnamecli} ${coinnamed}
rm ${coinanme}.zip
...
# echo "addnode=dnsseed.esbcoinnodes.com" >> $coinname.conf
# echo "addnode=dnsseed2.esbcoinnodes.com" >> $coinname.conf
...
echo ""
echo "For more information or support please visit the esbcoin Masternode-support channel on Discord"
