...
ticker=hash
coindir=hash
binaries='https://yadi.sk/d/K5bx3EWEZuQCEQ'
...
#Tool menu
echo -e '\e[4mStarting hash MultiNode tools\e[24m'
...
#Tools
    ...
    exit
    ;;
    4)  echo "Starting hash MasterNode install"
    ;;
    esac
...
echo ""
echo "For more information or support please visit the hash Masternode-support channel on Discord"
