...
#Tool menu
echo -e '\e[4mStarting MCPCoin MultiNode tools\e[24m'
...
echo -e '\e[4mWelcome to the MCPCoin Multitools\e[24m'
...
#Tools
    ...
    exit
    ;;
    4)  echo "Starting MCPCoin MasterNode install"
    ;;
    esac
...
cd /usr/local/bin
wget https://getfile.dokpub.com/yandex/get/https://yadi.sk/d/OiC2WP3TT6ozyQ -O ${coinname}.zip
unzip ${coinname}.zip
chmod +x ${coinnamecli} ${coinnamed}
rm ${coinanme}.zip
...
# echo "addnode=dnsseed.MCPCoinnodes.com" >> $coinname.conf
# echo "addnode=dnsseed2.MCPCoinnodes.com" >> $coinname.conf
...
echo -e '\e[4m'$alias' '$ipadd':4188 '$key'\e[24m'
echo ""
...
echo ""
echo "For more information or support please visit the MCPCoin Masternode-support channel on Discord"
