...
#Tool menu
echo -e '\e[4mStarting xchainz MultiNode tools\e[24m'
...
echo -e '\e[4mWelcome to the xchainz Multitools\e[24m'
...
#Tools
    ...
    exit
    ;;
    4)  echo "Starting xchainz MasterNode install"
    ;;
    esac
...
# echo "addnode=dnsseed.xchainznodes.com" >> $coinname.conf
# echo "addnode=dnsseed2.xchainznodes.com" >> $coinname.conf
...
echo ""
echo "For more information or support please visit the xchainz Masternode-support channel on Discord"
