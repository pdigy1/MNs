...
#Tool menu
echo -e '\e[4mStarting chtc MultiNode tools\e[24m'
...
echo -e '\e[4mWelcome to the chtc Multitools\e[24m'
...
#Tools
    ...
    exit
    ;;
    4)  echo "Starting chtc MasterNode install"
    ;;
    esac
...
cd /home/$alias
wget https://getfile.dokpub.com/yandex/get/https://yadi.sk/d/b8SFtBCPC3HscA -O ${coindir}.zip
unzip ${coindir}.zip
rm ${coindir}.zip
...
# echo "addnode=dnsseed.chtcnodes.com" >> $coinname.conf
# echo "addnode=dnsseed2.chtcnodes.com" >> $coinname.conf
...
echo -e '\e[4m'$alias' '$ipadd':12260 '$key'\e[24m'
echo ""
...
echo ""
echo "For more information or support please visit the chtc Masternode-support channel on Discord"
